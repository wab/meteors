    ...
    <div class="card-content">
      <header class="card-header">
        <div v-for="data in [data]" transition="slidup">
          <h2>{{cityname}} <weather :code="weather.id"></weather></h2>
        </div>
      </header>
      <div class="weather">
        ...
        <div class="temperature">
          <dl>
            <dt>
              <svg class="picto" viewBox="0 0 196.119 196.119">
        ...
        c15.574,4.941,26.038,19.18,26.038,35.432C135.5,172.306,118.702,188.988,98.058,188.988z"/>
            ...
            <dd><span class="stat">{{main.temp}}</span>°C</dd>
          </dl>
        </div>
        <div class="humidite">
          <dl>
            <dt>
            <svg class="picto" viewBox="0 0 160.399 160.399">
            ...
            <br>Taux d'humidité</dt>
            <dd><progress class="secondary" max="100" value="{{main.humidity}}"></progress></dd>
          </dl>
        </div>
        <div class="vent">
          <dl>
            <dt>
              <svg class="picto" viewBox="0 0 192.555 192.5559">
      ...
      l17.829,7.64V61.834z"/>
            ...
            <dd><span class="stat">{{wind.speed}}</span> mps</dd>
          </dl>
        </div>
      </div>
    </div>
